    ...
    <section className="section-promo">
      ...
      <aside className="content-promo">
        ...
        <p className="description-promo">
          Este eBook reúne 28 receitas incríveis, incluindo saladas, sopas,
          pratos principais e sobremesas deliciosas. Alimente-se bem, perca peso
          e sinta-se melhor com refeições que são tão nutritivas quanto
          saborosas. Aproveite essa oportunidade para transformar sua
